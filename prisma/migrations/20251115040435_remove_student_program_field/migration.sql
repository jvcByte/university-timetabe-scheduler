...
INSERT INTO "new_Student" ("createdAt", "departmentId", "email", "id", "name", "semester", "studentGroupId", "studentId", "updatedAt", "userId", "year") SELECT "createdAt", "departmentId", "email", "id", "name", "semester", "studentGroupId", "studentId", "updatedAt", "userId", "year" FROM "Student";
DROP TABLE "Student";
