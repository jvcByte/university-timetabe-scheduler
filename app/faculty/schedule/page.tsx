...
export default async function FacultySchedulePage() {
      ...
      <div className="p-8">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          ...
          <p className="text-yellow-800">
            Your account is not linked to an instructor profile. Please contact
            the administrator to set up your instructor profile.
          </p>
        </div>
      </div>
    );
  ...
  // Get published timetables for this instructor
  const { timetables } = await getPublishedTimetablesForFaculty(instructor.id);
    ...
    <div className="p-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          View your published teaching schedules for {instructor.name}
        </p>
      </div>
